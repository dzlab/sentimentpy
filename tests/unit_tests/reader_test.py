...
class ReaderTest(TestCase):
    ...
    def it_should_create_comment_from_lines_test(self):
    ...
    def it_should_consume_fake_input_file_test(self):
        comment = Comment()
        comments_file = ReaderTest.FakeInput()
        Reader.consume_(comment, comments_file.readline())
        Reader.consume_(comment, comments_file.readline())
        Reader.consume_(comment, comments_file.readline())
        Reader.consume_(comment, comments_file.readline())
        Reader.consume_(comment, comments_file.readline())
